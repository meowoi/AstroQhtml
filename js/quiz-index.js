/* js/quiz-index.js — MUC LUC NGAN HANG CAU HOI + BANG NGUON + BO NAP.
   ...
   BA THU TRONG FILE NAY
     ...
     LV     do kho 1/2/3. 0/162 cau chua khai.
...
window.AstroQQuestions = (function () {
  ...
  var LV = {
    ...
    "ai-why-fast": 3, "algorithm": 2, "algorithm-is-an-opinion": 3,
    "andromeda-nearest-large-galaxy": 2, "asteroid-belt": 2, "asteroid-jupiter-stopped": 3,
    ...
    "bh-not-hole": 1, "bias-not-on-purpose": 3, "bias-who-is-served": 3, "black-hole": 2,
    "black-hole-light": 2, "bone-loss-in-space": 2, "cassini-13-years-at-saturn": 2, "cmb": 1,
    "cmb-oldest-light": 2, "cmb-when": 3, "comet-tail": 3, "comet-two-tails": 2,
    "comet-what": 1, "condition": 1, "dwarf": 3, "dwarf-ceres": 2, "dwarf-pluto": 1,
    "earth-eight-light-minutes": 2, "earth-in-milky-way": 1, "eclipse-annular-farthest-ring": 1,
    ...
    "eclipse-umbra-total-blocked": 2, "eclss-three-systems": 1, "exo-rogue": 3, "exoplanet": 1,
    "exoplanet-transit": 2, "fluid-shift-to-head": 2, "force-is-a-vector": 2,
    "four-forces-on-a-rocket": 1, "gaia-3d-map-of-galaxy": 1,
    "gaia-measures-position-and-motion": 2, "grav-two-rules": 3, "gravity": 1,
    "gravity-distance": 2, "life-needs-atmosphere": 2, "light-year-is-distance": 1, "loop": 2,
    ...
    "orbit-needs-balance": 3, "orbits-are-ellipses": 1, "oxygen-from-electrolysis": 3,
    "parallax-two-viewings": 2, "perseverance-seeks-ancient-life": 2, "planet": 3,
    "planet-count": 1, "planet-ice-giants": 2, "plants-water-in-space": 3,
    ...
    "sequence": 1, "solar-cell-absorbs-photons": 2, "solid-engine-cannot-be-stopped": 3,
    "solid-engine-propellant-mixed": 2, "space-biology-open-question": 2, "star": 1,
    ...
    "supernova-what": 1, "units-lost-an-orbiter": 2, "webb-looks-back-13-billion": 2,
    "webb-sees-infrared": 3
  };
