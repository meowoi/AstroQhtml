/* js/quiz-index.js — MUC LUC NGAN HANG CAU HOI + BANG NGUON + BO NAP.
   ...
   BA THU TRONG FILE NAY
     ...
     LV     do kho 1/2/3. 0/130 cau chua khai.
...
window.AstroQQuestions = (function () {
  ...
  var LV = {
    "ai-can-do-what": 2, "ai-ethics-governance": 3, "ai-ethics-trustworthy": 2, "ai-what-is": 1,
    "ai-why-fast": 3, "algorithm": 2, "algorithm-is-an-opinion": 3, "asteroid-belt": 2,
    ...
    "bias-who-is-served": 3, "black-hole": 2, "black-hole-light": 2, "cmb": 1,
    "cmb-oldest-light": 2, "cmb-when": 3, "comet-tail": 3, "comet-two-tails": 2,
    "comet-what": 1, "condition": 1, "dwarf": 3, "dwarf-ceres": 2, "dwarf-pluto": 1,
    ...
    "eclipse-shadow-umbra-penumbra": 1, "eclipse-umbra-total-blocked": 2, "exo-rogue": 3,
    "exoplanet": 1, "exoplanet-transit": 2, "grav-two-rules": 3, "gravity": 1,
    "gravity-distance": 2, "loop": 2, "lunar-atmosphere-dust-redder": 2,
    "lunar-definition-earth-shadow": 1, "lunar-difference-name-darker": 3,
    "lunar-earth-between-sun-moon": 1, "lunar-night-side-visibility": 3,
    "lunar-partial-imperfect-alignment": 2, "lunar-penumbral-faint-outer-shadow": 2,
    "lunar-phase-full-moon": 1, "lunar-rayleigh-scattering-red-light": 2,
    "lunar-red-filtered-atmosphere": 2, "lunar-shadow-huge-earth": 3,
    "lunar-sunrises-sunsets-projected": 3, "lunar-umbra-inner-shadow": 1, "meteor": 2,
    "meteor-fireball": 3, "meteor-where": 1, "meteorite": 2, "meteorite-name": 1,
    "meteorite-survive": 3, "meteoroid": 1, "meteoroid-chain": 3, "meteoroid-daily-mass": 2,
    "ml-humans-still-check": 3, "ml-learns-from-data": 2, "ml-trained-by-hubble": 1, "moon": 1,
    "moon-largest": 2, "moon-most-not-planets": 3, "nebula": 1, "nebula-gas": 3,
    "nebula-planetary": 2, "planet": 3, "planet-count": 1, "planet-ice-giants": 2, "sensor": 1,
    "sensor-fans-move": 2, "sensor-robot-sees": 1, "sensor-why-autonomous": 3, "sequence": 1,
    "star": 1, "star-arcturus-red-giant": 2, "star-betelgeuse-red-giant": 2,
