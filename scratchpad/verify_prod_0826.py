# -*- coding: utf-8 -*-
"""verify_prod_0826.py — DO TREN BAN THAT sau khi push + deploy 26/08/2026.

    python scratchpad/verify_prod_0826.py

Do dung thu mot dua tre gap: mo Khu Huan Luyen, thay 11 the va KHONG the nao
khoa, roi vao ARCADE-11 choi thang mot ban va doc duoc cau kien thuc.

⚠️ Bo `verify_*` KHONG duoc dua vao cong push (`run_gate.py` liet ke ly do): no
   do tren ban that nen chi chay SAU khi GitHub Pages xay xong (~1-2 phut).
...
⚠️ Chay CA HAI ngon ngu: hai lan dau lop game quyet dinh len ban that deu lot mot
   loi chi hien o mot ngon ngu.
"""
import sys
