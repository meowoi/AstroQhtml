...
| Mini-game *(đếm lại 05/09/2026)* | **12 khai báo, 12 chạy được và ĐÃ MỞ HẾT** — 6 game lớp HÀNH ĐỘNG (né thiên thạch · phòng thủ 360° · ghép chòm sao · đường đua · mê cung · bắt sao băng) + **6** game lớp QUYẾT ĐỊNH (sinh tồn · liên lạc · tuần hoàn · đối chiếu · dẫn tuyến · **phân loại**). ⚠️ Bốn game lớp quyết định bị khoá 19/08 → **mở 26/08/2026**; ARCADE-11 thêm cùng ngày, **ARCADE-12 "Trạm Phân Loại" thêm 05/09/2026**. ⚠️ **6 khuôn** lớp quyết định đã dùng: *chọn thẻ · xếp thứ tự · chia ngân sách · soi lỗi bảng · lưới-nối · **dạy máy*** — game thứ 13 **không được dùng lại** cái nào (`docs/decisions/002`). ⚠️⚠️ Khuôn **lưới-nối đã dùng 1/2 suất và suất còn lại ĐÃ CÓ CHỦ**: cơ chế "kéo đường nối hai đầu cùng loại" (kiểu Flow Free) là **cùng khuôn đó**, không phải khuôn mới — đừng đề xuất nó như một game mới của lớp này. ⚠️ Khuôn **dạy máy** (ARCADE-12) chạy trên `js/teach-machine.js` — k-NN vanilla, **0 thư viện ML, 0 byte mạng**; đề xuất nào cần "AI thật" phải giải thích vì sao k-NN/perceptron trên vài đặc trưng số là không đủ |
